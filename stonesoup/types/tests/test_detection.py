...
from ...types.detection import CompositeDetection, Detection, CompositeMissedDetection
...
def test_missed_composite_detection():
    # Test bool
    assert not CompositeMissedDetection()
