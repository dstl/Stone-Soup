...
scenario3 = ('longitude', {'Class': Longitude, 'func': mod_bearing})
scenario4 = ('latitude', {'Class': Latitude, 'func': mod_elevation})
...
class TestAngle:
    ...
    def test_degrees(self, Class, func):
        b1 = Class(np.pi/4)  # pi/4 radians = 45 degrees
