...
from ...augmentor import IdentityAugmentor
from ...models.transition.linear import ConstantVelocity
from ...types.matrix import TransitionMatrix
from ...types.mixture import GaussianMixture
from ...types.numeric import Probability
from ...types.prediction import ModelAugmentedWeightedGaussianStatePrediction, Prediction
from ...types.state import ModelAugmentedWeightedGaussianState
from ...types.update import ModelAugmentedWeightedGaussianStateUpdate, Update
...
model_augmentor = IdentityAugmentor(
...
@pytest.mark.parametrize(
    ...
    [(priors,
     ...
     (GaussianMixture([Update.from_state(prior, hypothesis=None)]),
      ModelAugmentedWeightedGaussianStateUpdate),
     (GaussianMixture([Update.from_state(prior, hypothesis=None),
