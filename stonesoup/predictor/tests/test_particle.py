...
def test_bernoulli_particle_no_detection(predictor, extra_params):
    ...
    rng1 = np.random.RandomState(1990)
    nbirth_parts = 9
    ...
    backup_sampler = ParticleSampler(distribution_func=rng1.uniform,
    ...
    prediction = predictor.predict(prior, timestamp=new_timestamp, random_state=rng1)
