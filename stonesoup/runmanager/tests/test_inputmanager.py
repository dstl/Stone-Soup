...
def test_set_stateVector():
    ...
    assert len(test_empty_vector_list) is 0
...
def test_set_covariance():
    ...
    assert len(test_empty_covar) is 0
...
def test_set_tuple():
    ...
    assert len(test_empty_list_tuple) is 0
...
def test_generate_parameters_combinations():
    ...
    test_params2 = [{'path': 'path_name4' , 'var_name': 'var_name4' , 'type': 'Probability',
                    ...
                    {'path': 'pathname6' , 'var_name': 'var_name6' , 'type': 'CovarianceMatrix',
                     'value_min': [[1, 2, 3], [4, 5, 6]], 'value_max': [[7, 8, 9], [10, 11, 12]], 'n_samples': [[3,3,3],[3,3,3]]}]
...
def test_generate_parameters_probability():
    ...
    test_prob_0nsamples_dict = IManager.generate_parameters_combinations([test_probability_0nsamples])
...
def test_generate_parameters_ndarray():
    ...
    test_ndarray_0nsamples = {'path': 'pathname10' , 'var_name': 'var_name10' , 'type': 'ndarray',
                              'value_min': np.array([1,2]), 'value_max': np.array([5,6]), 'n_samples': [0,0]}
...
def test_generate_parameters_large_nsamples():
    ...
    assert test_large_nsamples_dict['path_name'][0] is 1
...
def test_generate_parameters_negative_nsamples():
    ...
    assert len(negative_nsamples_dict) is 1
...
def test_get_array_list():
    ...
    assert len(test_empty_array_list) is 1
    assert test_empty_array_list[0] is ()
...
def test_get_ndarray_trackers_list():
    ...
    assert len(test_empty_ndarray_list) is 1
...
def test_get_covar_trackers_list():
    ...
    assert len(test_empty_covar_list) is 1
...
def test_generate_all_combos():
    ...
    assert len(test_empty_combinations) is len(test_empty_trackers_dict['param1']) * len(test_empty_trackers_dict['param2'])
    ...
    assert len(test_empty_combinations2) is len(test_empty_trackers_dict2['param1']) * len(test_empty_trackers_dict2['param2'])
