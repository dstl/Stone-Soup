...
def test_tracks_to_csv(tmp_path):
    test_dir_name = tmp_path
    ...
    with open(os.path.join(test_dir_name, "tracks.csv")) as csvfile:
...
def test_metrics_to_csv(tmp_path):
    ...
    with open(os.path.join(test_dir_name, "metrics.csv")) as csvfile:
...
def test_detection_to_csv(tmp_path):
    test_dir_name = tmp_path
    ...
    with open(os.path.join(test_dir_name, "detections.csv")) as csvfile:
...
def test_groundtruth_to_csv(tmp_path):
    test_dir_name = tmp_path
    ...
    with open(os.path.join(test_dir_name, "groundtruth.csv")) as csvfile:
...
def test_parameters_to_csv(tmp_path):
    test_dir_name = tmp_path
    ...
    with open(os.path.join(test_dir_name, "parameters.json")) as json_file:
...
def test_generate_config(tmp_path):
    ...
    with open(os.path.join(test_dir_name, "config.yaml")) as file:
