...
if __name__ == "__main__":
    ...
    try:
        ...
        configInput = "C:\\Users\\gbellant.LIVAD\\Documents\\Projects\\serapis\\Serapis C38 LOT 1\\config.yaml"
        logging.error(e)

    try:
        parametersInput = args[1]
    except Exception as e:
        parametersInput = "C:\\Users\\gbellant.LIVAD\\Documents\\Projects\\serapis\\Serapis C38 LOT 1\\parameters.json"
        logging.error(e)
