...
class CategoricalMeasurement(MeasurementModel):
    ...
    :math:`\{y_k|k\in\Z_{\ge0}\}` and a measurement vector :math:`(z_k)_i = P(y_i, k)` will define
    ...
    def function(self, state, noise=False, **kwargs):
        ...
        state: :class:`~.State`
            ...
            distribution over the set of possible hidden states :math:`\{\phi_m|m\in\Z_{\ge0}\}`
        noise: bool
