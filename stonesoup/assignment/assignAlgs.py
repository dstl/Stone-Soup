...
# maximize A boollean value. If true, the minimization problem is transformed
#          into a maximization problem. The default if this parameter is
...
#               column. 0 entries signify unassigned rows. If the problem is
...
#then gain, col4row, and row4col are returned as numpy.empty(0) values.
#
#The algorithm is described in detail in [1] and [2]. This is a Python
#translation of the C and Matlab functions in the Tracker Component Library
# of https://github.com/USNavalResearchLaboratory/TrackerComponentLibrary
#
#EXAMPLE 1:
#import numpy
#import assignAlgs
