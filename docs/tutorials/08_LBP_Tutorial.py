...
# Let’s denote the joint association events as :math:`a^i_t=j \in \left\{NONE, x, y, z\right\}`, where :math:`NONE`
...
#        ith belief propagation. IEEE Transactions on Aerospace and Electronic Systems, 50(4):2942–2959, 2014
