...
# Introduction
# ------------
# Bayesian search is a search algorithm that makes use of Bayesian statistics to incorporate
# prior beliefs about a target, represented as a probability distribution, into the calculation of
# optimal search behaviours.
#
...
# containing the target (i.e., the greatest particle weight). We can achieve this by taking the
# list of possible actions generated by our platform's movement controller and evaluating each one
# with a reward function that reflects this goal.
#
# We will therefore create a simple custom reward function that sums the weights of all particles
# within the sensor's field of view. This will result in movements that return a greater sum of
# weights being chosen by our sensor manager.
