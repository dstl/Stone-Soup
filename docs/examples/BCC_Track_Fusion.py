...
from stonesoup.mixturereducer.gaussian import BasicConvexCombination
from stonesoup.measures.multi import MeanMeasure, RecentStateSequenceMeasure
...
track_associator = OneToOneTrackAssociator(
        measure=MeanMeasure(
            RecentStateSequenceMeasure(n_states_to_compare=5,
                                       state_measure=Euclidean(mapping=[0, 2, 4]))))
